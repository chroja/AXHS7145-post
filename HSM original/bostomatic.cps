...
description = "Generic BostoMatic";
vendor = "Autodesk, Inc.";
...
function onCyclePoint(x, y, z) {
  if (isFirstCyclePoint()) {
    ...
    var P = (cycle.dwell == 0) ? 0 : clamp(0.001, cycle.dwell, 150); // in seconds
    ...
    case "tapping":
      writeBlock("V60", "D" + dFormat.format(cycle.bottom * (unit == MM ? 1000 : 10000)));
      // writeBlock("V64", "D" + dFormat.format(cycle.retract * (unit == MM ? 1000 : 10000)));
      writeBlock("V89", "D" + dFormat.format(spindleRPM * (unit == MM ? 1000 : 10000)));
