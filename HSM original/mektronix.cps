/**
  ...
  Mektronix post processor configuration.

  $Revision: 40469 $
  $Date: 2015-12-15 11:50:07 +0100 (ti, 15 dec 2015) $
  
  FORKID {816C8C10-5114-47d4-B996-207EA605F7E8}
*/

description = "Generic Mektronix";
vendor = "Mektronix";
vendorUrl = "http://mektronixtech.com";
legal = "Copyright (C) 2012-2015 by Autodesk, Inc.";
certificationLevel = 2;
minimumRevision = 24000;

longDescription = "Generic Mektronix post. Make sure to set the 'highFeedrate' property used for rapid traversal.";
...
function onOpen() {
  ...
  if (false) { // note: setup your machine here
    ...
    var cAxis = createAxis({coordinate:2, table:true, axis:[0, 1, 0], range:[-360,360], preference:1});
