/**
  ...
  ShopBot ISO post processor configuration.

  $Revision: 40469 $
  $Date: 2015-12-15 11:50:07 +0100 (ti, 15 dec 2015) $
  
  FORKID {B761771A-363A-40F4-942E-A3105A8E0E05}
*/

description = "ShopBot ISO";
vendor = "Autodesk, Inc.";
...
function onRadiusCompensation() {
  ...
  if (pendingRadiusCompensation >= 0) {
    error(localize("Radius compensation G41/G42 is not supported by ShopBot."));
    return;
  }
}
