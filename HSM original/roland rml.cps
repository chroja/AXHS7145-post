...
description = "Generic Roland RML";
vendor = "Roland";
vendorUrl = "https://www.rolanddga.com";
legal = "Copyright (C) 2012-2015 by Autodesk, Inc.";
certificationLevel = 2;
minimumRevision = 24000;

longDescription = "Generic post for Roland RML. By default the post will output code for MDX15 and MDX 20. Make sure to set turn on one of the properties 'MDX15or20', 'MDX40', and 'MDX540'.";
...
properties = {
  MDX15or20: true, // set machine type
