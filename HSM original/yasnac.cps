...
var toolFormat = createFormat({width:4, zeropad:true, decimals:0}); // change to 2 for old controls
    ...
    if (workOffset != currentWorkOffset) {
      ...
      if (j > 1) {
        ...
        if ((54 + code) != currentWorkOffset) {
          writeBlock(gFormat.format(54 + code)); // G54->G59 (J0 or J1)
