...
description = "Generic Roland ISO";
vendor = "Autodesk, Inc.";
...
properties = {
  ...
  useToolChanger: true // automatic tool changer (ATC)
};
...
function onClose() {
  ...
  if (!machineConfiguration.hasHomePositionX() && !machineConfiguration.hasHomePositionY()) {
    ...
    writeBlock(gAbsIncModal.format(91));
    writeBlock(gFormat.format(28), "X" + xyzFormat.format(0), "Y" + xyzFormat.format(0)); // return to home
  } else {
    var homeX;
