...
function onCyclePoint(x, y, z) {
  if (isFirstCyclePoint()) {
    ...
    case "drilling":
      writeBlock(
        gRetractModal.format(properties.useG99 ? 99 : 98), gAbsIncModal.format(90), gCycleModal.format(81),
    ...
    case "counter-boring":
      if (P > 0) {
        writeBlock(
          gRetractModal.format(properties.useG99 ? 99 : 98), gAbsIncModal.format(90), gCycleModal.format(82),
          getCommonCycle(x, y, z, cycle.retract),
    ...
    case "chip-breaking":
      ...
      if (P > 0) {
        ...
        writeBlock(
          gRetractModal.format(properties.useG99 ? 99 : 98), gAbsIncModal.format(90), gCycleModal.format(73),
          getCommonCycle(x, y, z, cycle.retract),
    ...
    case "deep-drilling":
      if (P > 0) {
        ...
        writeBlock(
          gRetractModal.format(properties.useG99 ? 99 : 98), gAbsIncModal.format(90), gCycleModal.format(83),
          getCommonCycle(x, y, z, cycle.retract),
          "Q" + xyzFormat.format(cycle.incrementalDepth),
    ...
    case "tapping":
      ...
      if (properties.usePitchForTapping) {
        writeBlock(
          gRetractModal.format(properties.useG99 ? 99 : 98), gAbsIncModal.format(90), gCycleModal.format((tool.type == TOOL_TAP_LEFT_HAND) ? 74 : 84),
          getCommonCycle(x, y, z, cycle.retract),
          "P" + milliFormat.format(P),
    ...
    case "left-tapping":
      ...
      if (properties.usePitchForTapping) {
        writeBlock(
          gRetractModal.format(properties.useG99 ? 99 : 98), gAbsIncModal.format(90), gCycleModal.format(74),
          getCommonCycle(x, y, z, cycle.retract),
          "P" + milliFormat.format(P),
          pitchOutput.format(tool.threadPitch)
        );
    ...
    case "right-tapping":
      ...
      if (properties.usePitchForTapping) {
        writeBlock(
          gRetractModal.format(properties.useG99 ? 99 : 98), gAbsIncModal.format(90), gCycleModal.format(84),
          getCommonCycle(x, y, z, cycle.retract),
          "P" + milliFormat.format(P),
          pitchOutput.format(tool.threadPitch)
        );
    ...
    case "fine-boring":
      writeBlock(
        gRetractModal.format(properties.useG99 ? 99 : 98), gAbsIncModal.format(90), gCycleModal.format(76),
        getCommonCycle(x, y, z, cycle.retract),
    ...
    case "back-boring":
      ...
      writeBlock(
        gRetractModal.format(properties.useG99 ? 99 : 98), gAbsIncModal.format(90), gCycleModal.format(87),
    ...
    case "reaming":
      if (P > 0) {
        writeBlock(
          gRetractModal.format(properties.useG99 ? 99 : 98), gAbsIncModal.format(90), gCycleModal.format(89),
          getCommonCycle(x, y, z, cycle.retract),
          "P" + milliFormat.format(P),
          feedOutput.format(F)
        );
        ...
        writeBlock(
          gRetractModal.format(properties.useG99 ? 99 : 98), gAbsIncModal.format(90), gCycleModal.format(85),
          getCommonCycle(x, y, z, cycle.retract),
          feedOutput.format(F)
        );
      }
    ...
    case "stop-boring":
      if (P > 0) {
        ...
        writeBlock(
          gRetractModal.format(properties.useG99 ? 99 : 98), gAbsIncModal.format(90), gCycleModal.format(86),
          getCommonCycle(x, y, z, cycle.retract),
          feedOutput.format(F)
        );
      }
    ...
    case "manual-boring":
      writeBlock(
        gRetractModal.format(properties.useG99 ? 99 : 98), gAbsIncModal.format(90), gCycleModal.format(88),
        getCommonCycle(x, y, z, cycle.retract),
        "P" + milliFormat.format(P), // not optional
        feedOutput.format(F)
      );
