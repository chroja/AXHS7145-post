/**
  ...
  NCT post processor configuration.

  $Revision: 40469 $
  $Date: 2015-12-15 11:50:07 +0100 (ti, 15 dec 2015) $
  
  FORKID {45EDAF00-A9B8-4679-90CD-345E8D810E86}
*/

description = "Generic NCT";
vendor = "NCT";
vendorUrl = "http://www.nctusa.com";
legal = "Copyright (C) 2012-2015 by Autodesk, Inc.";
certificationLevel = 2;
minimumRevision = 24000;

longDescription = "Generic NCT post.";
...
function writeComment(text) {
  writeln("(" + filterText(String(text).toUpperCase(), permittedCommentChars).substr(0, 16) + ")");
}
...
function onOpen() {
  ...
  if (programName) {
    ...
    if (programComment) {
      writeln("%O" + oFormat.format(programId) + " (" + filterText(String(programComment).toUpperCase(), permittedCommentChars).substr(0, 16) + ")");
    } else {
...
function onDwell(seconds) {
  ...
  writeBlock(gFeedModeModal.format(94), gFormat.format(4), "P" + secFormat.format(Math.max(seconds, 0.001)));
}
