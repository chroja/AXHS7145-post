...
description = "Generic FANUC (with G91)";
vendor = "Fanuc";
  ...
  if (isFullCircle()) {
    ...
    default:
      if (properties.allow3DArcs) {
        ...
        writeBlock(gAbsIncModal.format(useIncremental ? 91 : 90), gMotionModal.format(clockwise ? 2.4 : 3.4), xOutput.format(ip.x), yOutput.format(ip.y), zOutput.format(ip.z));
