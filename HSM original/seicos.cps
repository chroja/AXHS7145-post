/**
  ...
  Seicos post processor configuration.

  $Revision: 40469 $
  $Date: 2015-12-15 11:50:07 +0100 (ti, 15 dec 2015) $
  
  FORKID {C3EEFA5E-9C53-444f-91A4-F2143DB375F3}
*/

description = "Generic Seicos";
vendor = "Autodesk, Inc.";
...
var currentHPCC = false;

function setHPCC(mode) {
  if (mode == currentHPCC) {
    return;
  }
  currentHPCC = mode;
...
function onCyclePoint(x, y, z) {
  if (isFirstCyclePoint()) {
    ...
    case "tapping":
      ...
      writeBlock(
        gFeedModeModal.format(94), // use feedrate instead of pitch
        gRetractModal.format(98),
        gAbsIncModal.format(90),
        gCycleModal.format((tool.type == TOOL_TAP_LEFT_HAND) ? 741 : 841),
        getCommonCycle(x, y, z, cycle.retract),
        "P" + milliFormat.format(P),
